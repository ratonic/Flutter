...
class HomePage extends StatelessWidget {
  ...
  void _showEditDialog(BuildContext context, UserController controller, UserModel user) {
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                controller.updateUser(updatedUser.id, updatedUser.username, updatedUser.email);
